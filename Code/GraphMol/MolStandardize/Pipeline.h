...
struct RDKIT_MOLSTANDARDIZE_EXPORT PipelineOptions {
  ...
  std::string metalNon {};
  bool allowPartialDisconnections {false};
  // normalizer options
  std::string normalizerData {
    ...
    "Normalize 1,3 conjugated cation\t[N,O;+0!H0:1]-[A:2]=[N!$(*~[N,O,P,S-]),O;+1H0:3]>>[*+1:1]=[*:2]-[*+0:3]\n"
    "Normalize 1,3 conjugated cation\t[n;+0!H0:1]:[c:2]=[N!$(*~[N,O,P,S-]),O;+1H0:3]>>[*+1:1]:[*:2]-[*+0:3]\n"
    "Normalize 1,5 conjugated cation\t[N,O;+0!H0:1]-[A:2]=[A:3]-[A:4]=[N!$(*~[N,O,P,S-]),O;+1H0:5]>>[*+1:1]=[*:2]-[*:3]=[*:4]-[*+0:5]\n"
    "Normalize 1,5 conjugated cation\t[n;+0!H0:1]:[a:2]:[a:3]:[c:4]=[N!$(*~[N,O,P,S-]),O;+1H0:5]>>[n+1:1]:[*:2]:[*:3]:[*:4]-[*+0:5]\n"
